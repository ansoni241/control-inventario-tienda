...
export default function Create({ customers, products }: CreateSaleProps) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // 🚫 Validar que pagos no superen el total
            if (totalPayments > totalVisual) {
                setClientErrors(prev => ({
                    ...prev,
    ...
    // 🧹 Limpiar error si ya no se supera el total
    if (clientErrors.payments_total && totalPayments <= totalVisual) {
        setClientErrors(prev => {
            const copy = { ...prev };
            delete copy.payments_total;
            return copy;
        });
    }
                        ...
                        <CardContent>
                            <form onSubmit={handleSubmit} className="space-y-6">
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    ...
                                    <div className="col-span-2 md:col-span-1">
                                        ...
                                        <select
                                            ...
                                            className="w-full dark:bg-black rounded-md border p-2"
                                        >
                                ...
                                <div className="mt-4">
                                    ...
                                    <InputError message={clientErrors.payments_total} />
                                </div>
