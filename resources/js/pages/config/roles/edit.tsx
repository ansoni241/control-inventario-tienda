...
interface Role {
    id: number;
    name: string;
    permissions: number[]; // ahora es array de IDs
}
...
export default function Edit({ role, groupedPermissions }: EditRoleProps) {
    const { data, setData, put, processing, errors } = useForm({
        name: role.name,
        permissions: role.permissions || [], // aseguramos que siempre sea un array
    });
            ...
            <div className="flex h-full flex-1 flex-col gap-4 rounded-xl p-4">
                <div className="rounded border p-6 shadow-xl">
                    <div className='flex items-center justify-between mb-5'>
                        <div className="text-xl text-slate-600">Editar Rol</div>
