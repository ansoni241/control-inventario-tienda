...
import { CreateCustomerFormData } from "@/types/customer";
...
export default function Create() {
    ...
    const { data, setData, post, errors, processing } = useForm<CreateCustomerFormData>({
        name: '',
        email: '',
        phone: '',
        address: '',
    ...
    const validateField = async (field: keyof CreateCustomerFormData, value: unknown) => {
        try {
            ...
            <div className="flex h-full flex-1 flex-col gap-4 rounded-xl p-4">
                <div className="rounded border p-6 shadow-xl">
                    <div className='flex items-center justify-between mb-5'>
                        <div className="text-xl text-slate-600">Crear Cliente</div>
