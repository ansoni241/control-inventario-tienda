...
import { CreateCustomerProps, EditCustomerFormData } from "@/types/customer";
...
export default function Edit({ customerData }: CreateCustomerProps) {

    const { data, setData, errors, processing, put } = useForm<EditCustomerFormData>({
    ...
    const validateField = async (field: keyof EditCustomerFormData, value: unknown) => {
        try {
            ...
            <div className="flex h-full flex-1 flex-col gap-4 rounded-xl p-4">
                <div className="rounded border p-6 shadow-xl">
                    <div className='flex items-center justify-between mb-5'>
                        <div className="text-xl text-slate-600">Editar Cliente</div>
